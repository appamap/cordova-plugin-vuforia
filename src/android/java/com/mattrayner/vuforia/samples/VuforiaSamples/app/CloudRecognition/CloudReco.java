...
import com.geteventro.trails.R;
    ...
    SampleAppMenuInterface
{
    ...
    private static final String kAccessKey = VuforiaPlugin.vuforia_access_key;//"efce628c764f89aef73c7b5c0de7925cced8e11f";
    private static final String kSecretKey = VuforiaPlugin.vuforia_secret_key;//"b6bb8b98dff5e78ae88236b6dd6af2d1187a0182";
    ...
    public void onVuforiaUpdate(State state)
    {
        ...
        } else if (statusCode == TargetFinder.UPDATE_RESULTS_AVAILABLE)
        {
            ...
            if (finder.getResultCount() > 0)
            {
                ...
                String url="";
                try{
                    JSONObject metadata_json = new JSONObject(result.getMetaData().toString().replace('“','"').replace('”','"'));
                    JSONObject obj=metadata_json.getJSONObject("object");
...
//                    json.put("message", url);
                ...
                VuforiaPlugin.initVuforiaCallback.sendPluginResult(res);

                VuforiaPlugin.url=url;
                finish();
